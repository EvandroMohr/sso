...
class AuthController {
	...
	protected $service,$userDAO;
	protected $authenticationService;
	
	public function __construct(ITokenService $tokenService = null, IUsuarioDAO $usuarioDAO = null){
	...
	public function createUser(){
		if(!isset($_POST['nome']) || !isset($_POST['email']) || !isset($_POST['cpf']) || !isset($_POST['passwd'])  || !isset($_POST['proxy'])){
